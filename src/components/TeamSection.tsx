      ...
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-4">
            Built by REVA University Students
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            School of Computer Science and Engineering — Mini Project (B22CI0605)
          </p>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {team.map((member, i) => (
            <motion.div
              ...
              className="bg-card border border-border rounded-xl p-6 text-center hover:shadow-lg hover:border-primary/20 gentle-animation group"
            >
