...
export function FooterSection() {
  return (
    <footer className="bg-foreground text-background py-16 px-6 lg:px-12 transition-colors duration-700">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-background/60">
              <a href="#prediction" className="block hover:text-background transition-colors duration-300">AI Prediction Engine</a>
              <a href="#records" className="block hover:text-background transition-colors duration-300">Blockchain Records</a>
              <a href="#methodology" className="block hover:text-background transition-colors duration-300">Methodology</a>
              <a href="#features" className="block hover:text-background transition-colors duration-300">Features</a>
            </div>
          </div>
          <div>
